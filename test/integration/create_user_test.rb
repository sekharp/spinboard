...
class CreateUserTest < ActionDispatch::IntegrationTest
  test 'guest can create user account and logout and login again' do
    ...
    fill_in "Email", with: "worace@gmail.com"
    fill_in "Password", with: "beards"
    fill_in "Password confirmation", with: "beards"
  ...
  test 'guest cannot login with credentials that have not been registered' do
    ...
    fill_in "Email", with: "meekathepopstar@gmail.com"
    fill_in "Password", with: "deathofme"
    click_button "Login"
